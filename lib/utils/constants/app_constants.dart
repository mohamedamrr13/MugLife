class AppConstants {
  ...
  static const String invalidExpiryDate = 'Invalid expiry date';
  static const String invalidCvv = 'Invalid CVV';
  static const String cardHolderRequired = 'Card holder name is required';
